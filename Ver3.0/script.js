const quizTitle = "Polynomial Quiz v3.0";
const storageKey = "polynomialQuizResults_v3";
...
function submitQuiz() {
  ...
  document.getElementById(
    "result"
  ).textContent = `You scored ${score} out of ${shuffledQuizData.length}!`;
...
function generatePDF() {
  ...
  doc.setFontSize(13);
  doc.text(
    `Score: ${quizResults.score} / ${quizResults.responses.length}`,
    20,
    y
  );
  y += 10;
